...
<section class="hero-wrap hero-wrap-2" style="background-image: url('images/r.jpg');">
    ...
    <section class="ftco-section">
        ...
        ?>
					<div class="col-lg-2 course ftco-animate" style="background-color: steelblue; margin-left: 3px; border-top-left-radius: 5%;">
						<div class="text pt-4">
							<p class="meta d-flex">
								<span style="color: white;"><i class="icon-user mr-2" style="color: white; background-color: white;"></i><?php echo $row["author"]; ?></span>
							
							</p>
							<h3><a href="#"><?php echo $row["head"]; ?></a></h3>
